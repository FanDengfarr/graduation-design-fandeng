...
<!DOCTYPE HTML>
	...
	<body>
		...
		<s:iterator value="listVideo" status="video">
        ...
        <tr>   
         ...
         <!-- currentPage为当前页 -->    
         <s:else>    
           <a href="ListVideo?page=1">第一页</a>    
           <a href="ListVideo?page=<s:property value="%{currentPage-1}"/>">上一页</a>    
         </s:else>    
        
         <s:if test="%{currentPage != totalPage}">    
         <a href="ListVideo?page=<s:property value="%{currentPage+1}"/>">下一页</a>    
         <a href="ListVideo?page=<s:property value="totalPage"/>">最后一页</a>    
         </s:if>    
